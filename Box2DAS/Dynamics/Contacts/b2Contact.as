package Box2DAS.Dynamics.Contacts {
	...
	public class b2Contact extends b2Base {
		...
		public function b2Contact(p:int, fA:b2Fixture = null, fB:b2Fixture = null) {
			_ptr = p;
			m_manifold = new b2Manifold(_ptr + 56);
			
			/// Address of b2Fixture + userData offset -> deref to AS3 = AS3 b2Fixture.
			m_fixtureA = fA ? fA : deref(mem._mr32(mem._mr32(_ptr + 48) + 56)) as b2Fixture;
			m_fixtureB = fB ? fB : deref(mem._mr32(mem._mr32(_ptr + 52) + 56)) as b2Fixture;
		}
		...
		/// Disabled (by user)
		public static var e_disabledFlag:int = 0x0020;
