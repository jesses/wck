package misc {
	...
	public class Util {
		...
		public static const D2R = Math.PI / 180;
		
		/// Multiply to convert radians to degrees.
		public static const R2D = 180 / Math.PI;
		
		/// 360 degrees in radians.
		public static const PI2 = Math.PI * 2;
		 ...
		 */
		public static function relocate(obj:DisplayObject, to:DisplayObjectContainer, depth:int = -1) {
			var m = localizeMatrix(to, obj);
		 ...
		 */
		public static function addChildAtPos(o:DisplayObjectContainer, child:DisplayObject, pos:Point, depth:int = -1):void {
			setPos(child, pos);
		 ...
		 */
		public static function findAncestorOfClass(o:DisplayObject, c:Class):DisplayObject {
			do {
				o = o.parent;
			} while(o && !(o as c));
			return o;
		...
		public static function localizeMatrix(to:DisplayObject, from:DisplayObject):Matrix {
			...
			var m2 = to.transform.concatenatedMatrix;
			m2.invert();
			m.concat(m2);
			return m;
		}
		 ...
		 */
		public static function getObjectsUnderPointByClass(o:DisplayObjectContainer, p:Point, c:Class, max:int = 0, exclude:Array = null):Array {
			var objs:Array = o.getObjectsUnderPoint(p);
			var found:Array = [];
			exclude ||= [];
		...
		public static function offsetQuality(s:Stage, amount:int):void {
			var qualities = [StageQuality.LOW, StageQuality.MEDIUM, StageQuality.HIGH, StageQuality.BEST];
